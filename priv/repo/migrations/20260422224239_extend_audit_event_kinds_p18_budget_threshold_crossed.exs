defmodule Kiln.Repo.Migrations.ExtendAuditEventKindsP18BudgetThresholdCrossed do
  @moduledoc """
  Phase 18 COST-02: extends `audit_events_event_kind_check` for `:budget_threshold_crossed`.
  """
