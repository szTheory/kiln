defmodule Kiln.Repo.Migrations.ExtendAuditEventKindsP8SpecDraftPromoted do
  @moduledoc """
  Phase 8 D-820: extends `audit_events_event_kind_check` to include
  `:spec_draft_promoted`.

  `down/0` hard-codes the prior 33-atom taxonomy (Plan 02-01 decision (d)).
  """
  ...
  def down do
    kinds_list = Enum.map_join(@prior_p3_kinds_33, ", ", &"'#{&1}'")
