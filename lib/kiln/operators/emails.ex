defmodule Kiln.Operators.Emails do
  @moduledoc """
  ...
  @from_address {"Kiln", "noreply@example.com"}
  ...
  def magic_link_email(user, url) do
    ...
    #{cta_button(dgettext("sigra", "Log in to %{app_name}", app_name: "Kiln"), url)}
    <p style="margin: 12px 0 0 0; font-size: 14px; color: #71717a; line-height: 1.5; font-family: #{@font_family}; word-break: break-all;">
      #{dgettext("sigra", "Or use this link:")} #{url}
    </p>
    """
    ...
    base_email(user.email)
    |> subject(dgettext("sigra", "Log in to %{app_name}", app_name: "Kiln"))
    |> html_body(base_layout(html_content))
    |> text_body(text_body)
  end
  ...
  def suspicious_login_email(user, details) do
    ...
    reset_url = "#{KilnWeb.Endpoint.url()}/users/reset-password"
  ...
  def mfa_enabled_email(user, _opts \\ []) do
    ...
    <p style="margin: 0 0 12px 0; font-size: 16px; color: #3f3f46; line-height: 1.5; font-family: #{@font_family};">
      #{dgettext("sigra", "Two-factor authentication has been enabled on your %{app_name} account. Your account is now more secure.", app_name: "Kiln")}
    </p>
    <p style="margin: 0 0 12px 0; font-size: 16px; color: #3f3f46; line-height: 1.5; font-family: #{@font_family};">
  ...
  def mfa_disabled_email(user, _opts \\ []) do
    settings_url = "#{KilnWeb.Endpoint.url()}/users/settings"
    ...
    <p style="margin: 0 0 12px 0; font-size: 16px; color: #3f3f46; line-height: 1.5; font-family: #{@font_family};">
      #{dgettext("sigra", "Two-factor authentication was disabled on your %{app_name} account. If this wasn't you, re-enable MFA and change your password.", app_name: "Kiln")}
    </p>
  ...
  def backup_code_used_email(user, opts \\ []) do
    ...
    <p style="margin: 0 0 12px 0; font-size: 16px; color: #3f3f46; line-height: 1.5; font-family: #{@font_family};">
      #{dgettext("sigra", "A backup code was used to sign in to your %{app_name} account. You have %{remaining} of 8 backup codes remaining.", app_name: "Kiln", remaining: remaining)}
    </p>
  ...
  def mfa_lockout_email(user, _opts \\ []) do
    ...
    <p style="margin: 0 0 12px 0; font-size: 16px; color: #3f3f46; line-height: 1.5; font-family: #{@font_family};">
      #{dgettext("sigra", "We detected multiple failed two-factor authentication attempts on your %{app_name} account. Verification has been temporarily locked for 15 minutes.", app_name: "Kiln")}
    </p>
    <p style="margin: 0 0 12px 0; font-size: 16px; color: #3f3f46; line-height: 1.5; font-family: #{@font_family};">
  ...
  def email_change_confirmation_email(_user, new_email, url) do
    ...
    <p style="margin: 0 0 12px 0; font-size: 16px; color: #3f3f46; line-height: 1.5; font-family: #{@font_family};">
      #{dgettext("sigra", "You requested to change your %{app_name} account email to this address. Click the button below to confirm the change.", app_name: "Kiln")}
    </p>
  ...
  def email_change_notification_email(user, new_email, cancel_url) do
    ...
    <p style="margin: 0 0 12px 0; font-size: 16px; color: #3f3f46; line-height: 1.5; font-family: #{@font_family};">
      #{dgettext("sigra", "Someone requested to change your %{app_name} account email from this address to %{new_email}. If this was you, no action is needed -- confirm the change from your new email.", app_name: "Kiln", new_email: escaped_new_email)}
    </p>
    <p style="margin: 0 0 12px 0; font-size: 16px; color: #dc2626; font-weight: 600; line-height: 1.5; font-family: #{@font_family};">
    ...
    #{dgettext("sigra", "Someone requested to change your %{app_name} account email from this address to %{new_email}. If this was you, no action is needed -- confirm the change from your new email.", app_name: "Kiln", new_email: new_email)}
  ...
  def email_changed_email(user) do
    ...
    <p style="margin: 0 0 12px 0; font-size: 16px; color: #3f3f46; line-height: 1.5; font-family: #{@font_family};">
      #{dgettext("sigra", "Your %{app_name} account email has been changed to this address. If you did not make this change, secure your account immediately.", app_name: "Kiln")}
    </p>
  ...
  def deletion_scheduled_email(user, scheduled_date, cancel_url) do
    ...
    <p style="margin: 0 0 12px 0; font-size: 16px; color: #3f3f46; line-height: 1.5; font-family: #{@font_family};">
      #{dgettext("sigra", "Your %{app_name} account has been deactivated and is scheduled for permanent deletion on %{date}. All sessions have been signed out.", app_name: "Kiln", date: formatted_date)}
    </p>
    <p style="margin: 0 0 12px 0; font-size: 16px; color: #3f3f46; line-height: 1.5; font-family: #{@font_family};">
  ...
  def deletion_cancelled_email(user, login_url) do
    ...
    <p style="margin: 0 0 12px 0; font-size: 16px; color: #3f3f46; line-height: 1.5; font-family: #{@font_family};">
      #{dgettext("sigra", "Your %{app_name} account deletion has been cancelled. Your account is active again. You can log in as usual.", app_name: "Kiln")}
    </p>
  ...
  def deletion_finalized_email(email) do
    ...
    <p style="margin: 0 0 12px 0; font-size: 16px; color: #3f3f46; line-height: 1.5; font-family: #{@font_family};">
      #{dgettext("sigra", "Your %{app_name} account and associated data have been permanently removed. If you'd like to use %{app_name} again in the future, you're welcome to create a new account.", app_name: "Kiln")}
    </p>
    """
  ...
  def password_changed_email(user, details) do
    ...
    <p style="margin: 0 0 12px 0; font-size: 16px; color: #3f3f46; line-height: 1.5; font-family: #{@font_family};">
      #{dgettext("sigra", "Your %{app_name} account password was changed.", app_name: "Kiln")}
    </p>
    <div style="margin: 16px 0; padding: 16px; background-color: #f4f4f5; border-radius: 8px;">
      <p style="margin: 0 0 8px 0; font-size: 14px; color: #3f3f46; line-height: 1.5; font-family: #{@font_family};">
        <strong>#{dgettext("sigra", "IP address:")}</strong> #{ip}
