...
| 03-07.1 | 03-07 | 3 | SAND-04 | (D-111/D-112 substrate; no new threat) | Dockerfile + limits + images.lock + build task | unit | `mix test test/kiln/sandboxes/limits_test.exs --max-failures=1 && mix compile --warnings-as-errors` | ✅ priv/sandbox/elixir.Dockerfile | ✅ |
| 03-07.2 | 03-07 | 3 | SAND-04, SEC-01 | T-03-07-01 | env allowlist + ContainerSpec hardened defaults + ImageResolver | unit | `mix test test/kiln/sandboxes/container_spec_test.exs test/kiln/sandboxes/image_resolver_test.exs test/kiln/sandboxes/env_builder_test.exs --max-failures=1` | ✅ lib/kiln/sandboxes/env_builder.ex | ✅ |
| 03-07.3 | 03-07 | 3 | SAND-04 | T-03-07-02 | CAS round-trip with audit per file | unit | `mix test test/kiln/sandboxes/hydrator_test.exs test/kiln/sandboxes/harvester_test.exs --max-failures=1` | ✅ lib/kiln/sandboxes/harvester.ex | ✅ |
