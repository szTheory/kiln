# Archived ROADMAP snapshot — v0.2.0 (pre-close)

**Captured:** 2026-04-22 · **Milestone:** v0.2.0 — operator dogfood (Phases 10–13). Below is an exact copy of `.planning/ROADMAP.md` before the post-milestone rewrite. The living roadmap is `.planning/ROADMAP.md` after close.
