# Archived REQUIREMENTS snapshot — v0.2.0

**Captured:** 2026-04-22 · **Milestone:** v0.2.0 closed. Root `.planning/REQUIREMENTS.md` is removed until **`/gsd-new-milestone`** creates a fresh file.
