# Archived ROADMAP snapshot — v0.3.0 (pre-close)

**Captured:** 2026-04-23 · **Milestone:** v0.3.0 — Scale → templates → operator intelligence (Phases **14–21**). Below is an exact copy of `.planning/ROADMAP.md` before the post-milestone rewrite. The living roadmap is `.planning/ROADMAP.md` after close.

---

# Roadmap: Kiln

**Updated:** 2026-04-23 — **Milestone v0.3.0** (Phases **14–21**)
