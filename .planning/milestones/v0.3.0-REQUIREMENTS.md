# Archived REQUIREMENTS snapshot — v0.3.0

**Captured:** 2026-04-23 · **Milestone:** v0.3.0 closed. Root `.planning/REQUIREMENTS.md` is removed until **`/gsd-new-milestone`** creates a fresh file.
